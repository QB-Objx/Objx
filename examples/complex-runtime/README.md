...
- `schema.sql`: resets and creates a multi-table relational schema
...
The script writes `examples/complex-runtime/app.sqlite`, runs the workflow, and prints a summary payload with counts, sample hydrated graph data, and compiled join SQL.
